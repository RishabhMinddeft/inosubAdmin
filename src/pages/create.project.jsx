    ...
    <>
          ...
          <CIRight>
            ...
            <InputOuter>
              <textarea
                ...
                placeholder="Give detailed information and the story behind your Project and create a context for the potential owner!"
              ></textarea>
            </InputOuter>
            ...
            <InputOuter>
              <input
                ...
                placeholder="Add the link about the project to provide detailed information about the project and direct the user to link."
              />
            </InputOuter>
            <label>
            ...
            <W50Outer>
              <W50>
                ...
                <InputOuter>
                  <input
                    ...
                    onChange={(e) =>
                      setSocialUrl({ ...socialUrl, youtube: e.target.value })
                    }
              ...
              <W50>
                <label className="mb-5">Discord </label>
                <InputOuter>
                  <input
                    type="text"
                    value={socialUrl.facebook}
                    onChange={(e) =>
                      setSocialUrl({ ...socialUrl, facebook: e.target.value })
                    }
                    placeholder="Enter URL"
                  />
                </InputOuter>
              ...
              <W50>
                ...
                <InputOuter>
                  <input
                    type="text"
                    value={socialUrl.tiwitter}
                    onChange={(e) =>
                      setSocialUrl({ ...socialUrl, tiwitter: e.target.value })
                    }
                    placeholder="Enter URL"
                  />
                </InputOuter>
              ...
              <W50>
                ...
                <InputOuter>
                  <input
                    ...
                    onChange={(e) =>
                      setSocialUrl({ ...socialUrl, instagram: e.target.value })
                    }
                    placeholder="Enter URL"
                  />
                </InputOuter>
            ...
            <PriceOuter>
              <InputOuter className="w100 mb-0">
                <input
                  ...
                  onChange={(e) =>
                    setTeam({ ...team, designation: e.target.value })
                  }
                  placeholder="Enter the Team designation here."
                />
              </InputOuter>
            </PriceOuter>
            ...
            {teams.map((team, key) => (
              <InfoBadge key={key}>
                <InfoBadgeDetail>
                  <div className="img-outer">
                    <img
                      src={
                        team.image
                          ? URL.createObjectURL(team.image)
                          : ProfileIMG
                      }
                      alt=""
                    />
                ...
                <FaTrashAlt
                  onClick={() => {
                    let newList = teams.filter(
                      (item) =>
                        item.name !== team.name ||
                        item.designation !== team.designation
                    );
                    setTeams(newList);
                  }}
                />
            ...
            <PriceOuter>
              <InputOuter className="w100 mb-0">
                <input
                  ...
                  placeholder="Enter the name of the Feature here."
                />
              </InputOuter>
            ...
            <PriceOuter>
              <InputOuter className="w100 mb-0">
                <textarea
                  ...
                  placeholder="Give detailed information of the Feature here."
                ></textarea>
              </InputOuter>
              <InputOuter className="mb-0">
                <CWBtn2
            ...
            {inGameFeatures.map((feature, key) => (
              <InfoBadge key={key}>
                ...
                <FaTrashAlt
                  onClick={() => {
                    let newList = inGameFeatures.filter(
                      (item) =>
            ...
            <BigInputOuter>
              <div className="big-input-box">
                ...
                Keep the project as "Coming Soon"
              </div>
            </BigInputOuter>
            ...
            />
            <label for="vehicle1"> Keep the project as "Coming Soon"</label>
            <br /> */}
      ...
      >
        <PleaseWait
          isLoading={loading}
          title={"Loading"}
          description={"Creating the project, please wait for a moment."}
        />
      </Modal>
    </>
  );
