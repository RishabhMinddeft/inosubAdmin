...
const MintItem = (props) => {
  ...
  const putOnSale = async () => {
    ...
    let params =
      saleState === "DUTCHAUCTION"
        ? [
            singleNFTDetails.tokenId,
            ...
            <CustomTabs2>
              ...
              <div className="tab-main">
                <div className="tab-list">
                  <button
                    className={saleState === "BUY" && "active"}
                    onClick={() => setSaleState("BUY")}
                  >
                    <img src={DollarIcon} alt="" /> Fixed Price{" "}
                  </button>
                  <button
                    className={saleState === "DUTCHAUCTION" && "active"}
                    onClick={() => setSaleState("DUTCHAUCTION")}
                  >
                    <img src={RocketIcon} alt="" /> Dutch Auction
                  </button>
                </div>
              ...
              <CustomRadioButton>
                <label class="radio-container">
                  ...
                  <input
                    type="radio"
                    checked={saleType === "public" ? "checked" : false}
                    name="radio"
                ...
                <label class="radio-container">
                  ...
                  <input
                    type="radio"
                    name="radio"
                    checked={saleType === "private" ? "checked" : false}
