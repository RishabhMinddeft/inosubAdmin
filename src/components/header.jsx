        ...
        <HeaderInner>
          <HeaderLeft>
            ...
            <DMenu>
              ...
              <div className="menu-outer">
                <NavLink to="https://launchpad.seedify.fund/">
                  IGO Launchpad
                </NavLink>
              </div>
              <div className="menu-outer">
                <NavLink to="https://staking.seedify.fund/">
                  Staking/Farming
                </NavLink>
              </div>
              <div className="menu-outer">
          ...
          <HeaderRight>
            <MMenu>
              <Bars
                className={isOpenMobileMenu ? "menu-active" : null}
              ...
              <Collapse onInit={onInit} isOpen={isOpenMobileMenu}>
                <div className="m-menu-outer">
                  ...
                  {authenticated.isLoggedIn && (
                    <CWBtn className="mobile-div">
                      {utility.getCompactAddress(authenticated.accounts[0])}
                    </CWBtn>
                  )}
                  {!authenticated.isLoggedIn && (
                    <CWBtn
                  ...
                  <LangConversion className="mobile-div">
                    ...
                    <p>
                      EN{" "}
                      <AiFillCaretDown
                        onClick={() => setIsOpenLangBox((state) => !state)}
                      />
                    </p>
                    <div className="lang-box">
                      <Collapse onInit={onInit} isOpen={isOpenLangBox}>
                        <ul>
                          ...
                          <li>
                            <a href="#">
                              <img src={GlobeIcon} alt="" /> TURKISH
                            </a>
                          </li>
                          <li>
                            <a href="#">
                              <img src={GlobeIcon} alt="" /> RUSSIAN
                            </a>
                          </li>
                          <li>
                            <a href="#">
                              <img src={GlobeIcon} alt="" /> PORTUGUESE
                            </a>
                          </li>
                          <li>
                            <a href="#">
                              <img src={GlobeIcon} alt="" /> SPANISH
                            </a>
                          </li>
                          <li>
                            <a href="#">
                              <img src={GlobeIcon} alt="" /> FRENCH
                            </a>
                          </li>
                        </ul>
                      </Collapse>
                  ...
                  <SocialList className="mobile-div">
                    <a href="https://twitter.com/SeedifyFund" target="blank">
                      <img src={IconTwitter} alt="" />
                    </a>
                    <a href="https://blog.seedify.fund/" target="blank">
                      <img src={IconMedium} alt="" />
                    </a>
                    <a href="https://t.me/seedifyfund" target="blank">
...
const HeaderMain = styled(FlexDiv)`
  ...
  right: 0;
  z-index: 99;
  background-image: url(${HeaderScrollBGImage});
  background-repeat-y: repeat;
  background-repeat-x: no-repeat;
  background-size: 100% 100%;
  :after {
    background-image: url(${NavHABg});
    width: 100%;
...
const ProfileBox = styled(FlexDiv)`
  background-image: url(${ProfileFrame});
...
const Bars = styled.div`
  background: url(${BarIcon}) no-repeat;
  width: 26px;
  height: 18px;
  &.menu-active {
    width: 22px;
